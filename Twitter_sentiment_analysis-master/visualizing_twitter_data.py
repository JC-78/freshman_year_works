...
class TweetAnalyzer():
    ...
    def tweets_to_data_frame(self, tweets):
        ...
        df['source'] = np.array([tweet.source for tweet in tweets]) #from iphone, computer, or?
...
if __name__=="__main__":
    ...
    tweets = api.user_timeline(screen_name="Narrator78", count=20) #collect 20 tweets from Donald Trump's tweeter

    #tweets = api.user_timeline(screen_name="realDonaldTrump", count=20) #collect 20 tweets from Donald Trump's tweeter
    df=tweet_analyzer.tweets_to_data_frame(tweets)
    #print(df.head(10)) #shows first 10
    #print(dir(tweets[0])) #shows what info can be collected.
